class Api::V1::SessionsController < Devise::SessionsController
  ...
  def create
    ...
    if resource.valid_password?(params[:user][:password])
      #NOT SURE WHY I need to comment this out .... referring to my other Project this line works
      #but here it breaks ... for now leaving this commented out as the _critical_path_ is set 
      #as this returns the AUTH_TOKEN
